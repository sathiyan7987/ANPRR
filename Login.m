...
% Last Modified by GUIDE v2.5 31-Mar-2018 16:07:11
...
%global opt;
opt=round(rand*10000);
set(handles.text6, 'String', num2str(opt));
disp(opt);
...
opt=get(handles.text6,'String');
optInput=get(handles.edit3,'String');
act=Login1(u,p,opt,optInput);

set(handles.text4, 'String', act);
